...
execute at @e[sort=nearest,limit=1,distance=..1] run fill ^ ^ ^17 ^ ^ ^17 end_rod[facing=west] keep
execute at @e[sort=nearest,limit=1,distance=..1] run fill ^ ^ ^16 ^ ^ ^16 end_rod[facing=down] keep
execute at @e[sort=nearest,limit=1,distance=..1] run fill ^ ^ ^15 ^ ^ ^15 end_rod[facing=south] keep
...
execute at @e[sort=nearest,limit=1,distance=..1] run fill ^ ^ ^11 ^ ^ ^11 end_rod[facing=west] keep
execute at @e[sort=nearest,limit=1,distance=..1] run fill ^ ^ ^10 ^ ^ ^10 end_rod[facing=down] keep
execute at @e[sort=nearest,limit=1,distance=..1] run fill ^ ^ ^9 ^ ^ ^9 end_rod[facing=south] keep
...
execute at @e[sort=nearest,limit=1,distance=..1] run fill ^ ^ ^5 ^ ^ ^5 end_rod[facing=west] keep
execute at @e[sort=nearest,limit=1,distance=..1] run fill ^ ^ ^4 ^ ^ ^4 end_rod[facing=down] keep
execute at @e[sort=nearest,limit=1,distance=..1] run fill ^ ^ ^3 ^ ^ ^3 end_rod[facing=south] keep
