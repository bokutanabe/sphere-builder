execute at @e[sort=nearest,limit=1,distance=..1] run fill ^ ^ ^ ^ ^ ^20 iron_bars keep
...
execute at @e[y_rotation=-1,sort=nearest,limit=1,distance=..1] run kill @e[name=sb-iron-bars,sort=nearest,limit=1,distance=..1]